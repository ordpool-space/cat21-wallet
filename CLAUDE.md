...
|---|---|---|
| mint / transfer / buy-offer build | `lockTime=21`, hard assert | `ordpool-sdk/src/cat21-{mint,transfer,offer}/*.helper.ts` |
...
<!-- long-rule: two-surface security boundary -->
