...
const CAT21_PROVIDER: WalletProvider = {
  id: 'Cat21Provider',
  name: 'Cat21 Wallet',
  // Cat21 logo data-uri filled in post-build by the manifest pipeline;
  // a placeholder cat silhouette so the field is non-empty in dev.
  icon: 'data:image/svg+xml;base64,',
