...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @leather.io/features bumped to 1.4.4
    * @leather.io/provider bumped to 1.6.25
    * @leather.io/queries bumped to 0.10.0
    * @leather.io/query bumped to 2.48.0
    * @leather.io/rpc bumped to 2.22.0
    * @leather.io/services bumped to 1.55.0
    * @leather.io/stacks bumped to 1.20.0
    * @leather.io/ui bumped to 1.111.5
...
## [2.104.4](https://github.com/leather-io/mono/compare/@leather.io/mobile-v2.104.3...@leather.io/mobile-v2.104.4) (2026-04-13)
...
## [2.104.3](https://github.com/leather-io/mono/compare/@leather.io/mobile-v2.104.2...@leather.io/mobile-v2.104.3) (2026-03-31)
...
## [2.104.2](https://github.com/leather-io/mono/compare/@leather.io/mobile-v2.104.1...@leather.io/mobile-v2.104.2) (2026-03-27)
...
## [2.104.1](https://github.com/leather-io/mono/compare/@leather.io/mobile-v2.104.0...@leather.io/mobile-v2.104.1) (2026-03-16)
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @leather.io/features bumped to 1.3.0
    * @leather.io/provider bumped to 1.6.21
    * @leather.io/queries bumped to 0.6.3
    * @leather.io/query bumped to 2.46.0
    * @leather.io/rpc bumped to 2.21.13
    * @leather.io/services bumped to 1.50.0
    * @leather.io/stacks bumped to 1.19.15
    * @leather.io/ui bumped to 1.108.1
    * @leather.io/utils bumped to 0.51.0

## [2.102.0](https://github.com/leather-io/mono/compare/@leather.io/mobile-v2.101.0...@leather.io/mobile-v2.102.0) (2026-03-04)
...
* The following workspace dependencies were updated
  * dependencies
    * @leather.io/ui bumped to 1.103.3
...
* implement inscription token details ([706f886](https://github.com/leather-io/mono/commit/706f886b2463ac0a6573272695e571c016a9c526))
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @leather.io/ui bumped to 1.73.1

### Dependencies

* The following workspace dependencies were updated
  * dependencies
    * @leather.io/tokens bumped to 0.19.0
    * @leather.io/ui bumped to 1.73.2
...
* The following workspace dependencies were updated
  * dependencies
    ...
    * @leather.io/crypto bumped to 1.11.2
    * @leather.io/provider bumped to 1.5.3
    * @leather.io/query bumped to 2.41.2
    * @leather.io/rpc bumped to 2.20.2
    * @leather.io/services bumped to 1.25.2
    * @leather.io/stacks bumped to 1.14.2
    * @leather.io/ui bumped to 1.77.2
    * @leather.io/utils bumped to 0.42.0
  * devDependencies
    * @leather.io/bitcoin bumped to 0.31.2
...
* **mobile:** implement token details, ref LEA-3015 ([7dc28af](https://github.com/leather-io/mono/commit/7dc28af0b0eaed78a9f63b0413d63de3ae000de6))
...
* drag-down-to-close and no back button in token details ([6acd2c1](https://github.com/leather-io/mono/commit/6acd2c196caa387c53910f0e65e23c71299e356a))
...
* The following workspace dependencies were updated
  * dependencies
    * @leather.io/analytics bumped to 3.11.0
    ...
    * @leather.io/provider bumped to 1.5.1
    * @leather.io/query bumped to 2.41.0
    * @leather.io/rpc bumped to 2.20.0
    * @leather.io/services bumped to 1.25.0
    * @leather.io/stacks bumped to 1.14.0
    * @leather.io/tokens bumped to 0.23.0
    * @leather.io/ui bumped to 1.77.0
...
* The following workspace dependencies were updated
  * dependencies
    * @leather.io/services bumped to 1.18.0
    * @leather.io/ui bumped to 1.72.0
...
* The following workspace dependencies were updated
  * dependencies
    * @leather.io/analytics bumped to 3.8.0
    ...
    * @leather.io/provider bumped to 1.3.0
    * @leather.io/query bumped to 2.38.0
    * @leather.io/rpc bumped to 2.17.0
    * @leather.io/services bumped to 1.16.0
    * @leather.io/stacks bumped to 1.11.0
    * @leather.io/ui bumped to 1.69.0
...
* The following workspace dependencies were updated
  * dependencies
    * @leather.io/analytics bumped to 3.6.1
    * @leather.io/bitcoin bumped to 0.26.6
    * @leather.io/constants bumped to 0.20.4
    * @leather.io/crypto bumped to 1.7.3
    * @leather.io/models bumped to 0.33.0
    * @leather.io/provider bumped to 1.2.18
    * @leather.io/query bumped to 2.37.6
    * @leather.io/rpc bumped to 2.16.3
    * @leather.io/services bumped to 1.13.0
    * @leather.io/stacks bumped to 1.10.7
    * @leather.io/ui bumped to 1.68.3
    * @leather.io/utils bumped to 0.35.1
  * devDependencies
    * @leather.io/bitcoin bumped to 0.26.6
...
* The following workspace dependencies were updated
  * dependencies
    * @leather.io/provider bumped to 1.2.0
    * @leather.io/ui bumped to 1.53.0
...
* The following workspace dependencies were updated
  * dependencies
    * @leather.io/bitcoin bumped to 0.20.0
    * @leather.io/provider bumped to 1.1.0
    * @leather.io/query bumped to 2.29.7
    * @leather.io/rpc bumped to 2.8.0
    * @leather.io/services bumped to 1.4.13
  * devDependencies
    * @leather.io/bitcoin bumped to 0.20.0
...
* The following workspace dependencies were updated
  * dependencies
    * @leather.io/analytics bumped to 3.3.1
    * @leather.io/bitcoin bumped to 0.19.35
    * @leather.io/constants bumped to 0.17.4
    * @leather.io/crypto bumped to 1.6.47
    * @leather.io/models bumped to 0.27.0
    * @leather.io/provider bumped to 1.0.7
    * @leather.io/query bumped to 2.29.0
    * @leather.io/rpc bumped to 2.6.7
    * @leather.io/services bumped to 1.4.6
    * @leather.io/stacks bumped to 1.6.4
    * @leather.io/ui bumped to 1.50.2
...
* The following workspace dependencies were updated
  * dependencies
    * @leather.io/analytics bumped to 3.2.4
    ...
    * @leather.io/ui bumped to 1.49.6
...
* The following workspace dependencies were updated
  * dependencies
    * @leather.io/analytics bumped to 3.2.3
    ...
    * @leather.io/provider bumped to 1.0.3
    * @leather.io/query bumped to 2.27.8
    * @leather.io/rpc bumped to 2.6.3
    * @leather.io/services bumped to 1.4.2
    * @leather.io/stacks bumped to 1.6.1
    * @leather.io/tokens bumped to 0.13.5
    * @leather.io/ui bumped to 1.49.5
...
* The following workspace dependencies were updated
  * dependencies
    * @leather.io/ui bumped to 1.25.1
...
* The following workspace dependencies were updated
  * dependencies
    * @leather.io/ui bumped to 1.21.0

## [1.32.0](https://github.com/leather-io/mono/compare/@leather.io/mobile-v1.31.1...@leather.io/mobile-v1.32.0) (2024-09-12)
...
* update secret key copy, ref leather-io/issues[#318](https://github.com/leather-io/mono/issues/318) ([8305fc3](https://github.com/leather-io/mono/commit/8305fc3c7416c6ef634ad500c79612473a5b7c91))

### Dependencies

* The following workspace dependencies were updated
  * dependencies
    * @leather.io/ui bumped to 1.20.0
...
* The following workspace dependencies were updated
  * dependencies
    * @leather.io/ui bumped to 1.17.0
...
* link to Add Wallet if no wallets created, ref leather-wallet/issues[#176](https://github.com/leather-io/mono/issues/176) ([177bdbd](https://github.com/leather-io/mono/commit/177bdbdd7272df8c2828cfefe1434a7bbcce4f01))
* security screen + toast + simple headers + localization ([eb84b45](https://github.com/leather-io/mono/commit/eb84b4501acd95e208b558b50c224a21ceeaf9f1))
...
* add buffer polyfill ([0c317e1](https://github.com/leather-io/mono/commit/0c317e1b861de40f5cbf2ca634e58e7172f33ed5))
* add react native storybook ([256bdec](https://github.com/leather-io/mono/commit/256bdec0979721b564a671d2bfedb9d3717da4b4))
...
* implement i18n with lingui ([bb805cb](https://github.com/leather-io/mono/commit/bb805cb3135323871e46f86a80d182fe710fa0f3))
...
* run expo prebuild, install detox, jest, expo config for detox ([4921410](https://github.com/leather-io/mono/commit/4921410ef6f3c350210c5fbdbac3e0fbf85ef51a))
...
* make expo work by making babel and metro files cjs ([0e0982d](https://github.com/leather-io/mono/commit/0e0982d4d795a3a099a9c4622f16c822f2ac0ed9))
* metro config tsconfig paths resolution ([36946fd](https://github.com/leather-io/mono/commit/36946fdeaabf9e64246b53d579d56c6c444befe1))
* pas de français pour l'instant ([6b09576](https://github.com/leather-io/mono/commit/6b0957621d8394a3fc3d0a91b0ef38a63f0ab7e3))
* precommit hooks. Use pnpm filtering instead of lint-staged ([23df54a](https://github.com/leather-io/mono/commit/23df54a5a790c82ba83b9cc5f3e9b4ab8bc1451b))
* rename Button.tsx to button.tsx ([1b7d06f](https://github.com/leather-io/mono/commit/1b7d06f1a89590af99d30320d07390f45e72187c))
...
* update babel and metro files references ([c40189b](https://github.com/leather-io/mono/commit/c40189bc9d2cff1e33a06ce0d04ad3f5c710e68b))
* update mobile styles ([8a44bdc](https://github.com/leather-io/mono/commit/8a44bdc760de318be6b5f045683292cd33538e01))
* use cjs file ([1c13a6e](https://github.com/leather-io/mono/commit/1c13a6e161e5f646f674e49c9d102ab0708bd939))
* use core tsconfig package, not root ([b4238d8](https://github.com/leather-io/mono/commit/b4238d8686b4cce7d34af414a36e0e702a20386c))
...
## [1.6.0](https://github.com/leather-io/mono/compare/mobile-v1.5.4...mobile-v1.6.0) (2024-06-11)
...
## [1.5.0](https://github.com/leather-io/mono/compare/mobile-v1.4.1...mobile-v1.5.0) (2024-06-05)
...
## [1.2.0](https://github.com/leather-io/mono/compare/mobile-v1.1.1...mobile-v1.2.0) (2024-04-23)
...
## [1.1.1](https://github.com/leather-io/mono/compare/mobile-v1.1.0...mobile-v1.1.1) (2024-04-23)

### Bug Fixes

* try out change in mobile for release please ([f659fb5](https://github.com/leather-io/mono/commit/f659fb55fad0be76b108b92eeeb8b04d5074bcd4))

## [1.1.0](https://github.com/leather-io/mono/compare/mobile-v1.0.0...mobile-v1.1.0) (2024-04-23)
